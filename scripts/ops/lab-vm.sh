...
DEFAULT_LAB_VM_CONTROLLER_MEMORY_MIB="2048"
DEFAULT_LAB_VM_CONTROLLER_VCPUS="1"
if [ "$(uname -s)" = "Darwin" ]; then
  DEFAULT_LAB_VM_CONTROLLER_DISK_SIZE="24576M"
  DEFAULT_LAB_VM_HEALTH_ATTEMPTS="180"
  DEFAULT_LAB_VM_CONTROLLER_MEMORY_MIB="4096"
  DEFAULT_LAB_VM_CONTROLLER_VCPUS="4"
fi
...
LAB_VM_CONTROLLER_MEMORY_MIB="${LAB_VM_CONTROLLER_MEMORY_MIB:-${DEFAULT_LAB_VM_CONTROLLER_MEMORY_MIB}}"
LAB_VM_CONTROLLER_VCPUS="${LAB_VM_CONTROLLER_VCPUS:-${DEFAULT_LAB_VM_CONTROLLER_VCPUS}}"
