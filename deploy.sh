...
# Create namespace
kubectl create ns ochami --dry-run=client -o yaml | kubectl apply -f -
...
kubectl delete pod -n ochami -l app.kubernetes.io/component=http-server --wait=false 2>/dev/null || true
...
echo "  kubectl get pods -n ochami"
echo ""
